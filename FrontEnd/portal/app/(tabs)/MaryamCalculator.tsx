...
const SyedAmaazCalculator: React.FC = () => {
  ...
  return(
    <View style={styles.container}>
      ...
      <View style={styles.header}><Text style={styles.headerText}>Design & Developed by Syed Amaaz</Text></View>
...
export default SyedAmaazCalculator;

const BUTTON_HEIGHT=70;
const styles=StyleSheet.create({
container:{flex:1,backgroundColor:"",paddingTop:Platform.OS==="android"? (StatusBar.currentHeight??0)+10:10,paddingHorizontal:10},
header:{paddingVertical:12,alignItems:"center"},
headerText:{color:"black",fontSize:14,letterSpacing:1},
...
button:{flex:1,height:BUTTON_HEIGHT,marginHorizontal:6,borderRadius:35,backgroundColor:"#2a2a2a",justifyContent:"center",alignItems:"center"},
operatorButton:{backgroundColor:"darkblue"},
equalButton:{flex:1,height:BUTTON_HEIGHT,marginHorizontal:6,borderRadius:35,backgroundColor:"purple"},
