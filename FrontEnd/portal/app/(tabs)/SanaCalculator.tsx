...
const SanaCalculator: React.FC = () => {
  ...
  return(
    <View style={styles.container}>
      ...
      <View style={styles.header}><Text style={styles.headerText}>Design by Sana Baig</Text></View>
...
export default SanaCalculator;

const BUTTON_HEIGHT=70;
const styles=StyleSheet.create({
container:{flex:1,backgroundColor:"#222222",paddingTop:Platform.OS==="android"? (StatusBar.currentHeight??0)+10:10,paddingHorizontal:10},
...
inputText:{color:"white",fontSize:28},
...
button:{flex:1,height:BUTTON_HEIGHT,marginHorizontal:6,borderRadius:35,backgroundColor:"#333333",justifyContent:"center",alignItems:"center"},
operatorButton:{backgroundColor:"#9b59b6"},
equalButton:{flex:1,height:BUTTON_HEIGHT,marginHorizontal:6,borderRadius:35,backgroundColor:"#ff69b4"},
