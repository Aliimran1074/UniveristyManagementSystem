...
const KausarCalculator: React.FC = () => {
  ...
  return(
    <View style={styles.container}>
      ...
      <View style={styles.header}><Text style={styles.headerText}>Design by Saba Eijaz</Text></View>
...
export default KausarCalculator;

const BUTTON_HEIGHT=70;
const styles=StyleSheet.create({
container:{flex:1,backgroundColor:"#1a1a1a",paddingTop:Platform.OS==="android"? (StatusBar.currentHeight??0)+10:10,paddingHorizontal:10},
...
button:{flex:1,height:BUTTON_HEIGHT,marginHorizontal:6,borderRadius:35,backgroundColor:"#2c2c2c",justifyContent:"center",alignItems:"center"},
operatorButton:{backgroundColor:"#e74c3c"},
equalButton:{flex:1,height:BUTTON_HEIGHT,marginHorizontal:6,borderRadius:35,backgroundColor:"#f1c40f"},
